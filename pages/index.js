      ...
      <div className={styles.container}>
        ...
        <div className={styles.serviceDiv}>
          ...
          <div className={styles.serviceWithImgDiv}>
            <ServiceWithImg data={{ services: serviceData, isImageSlide }} />
          </div>
          {/* service list without image */}
          <div className={styles.serviceListDiv}>
            <ServiceList data={{ services: serviceData }} />
          </div>
        </div>
        ...
        <div className={styles.estimateDiv}>
          <Estimate data={ { services: serviceData, estimateData } }/>
        </div>
      </div>
  )
};
...
export const getServerSideProps = async () => {
  ...
  const serviceData = await sanityFetch('service');
